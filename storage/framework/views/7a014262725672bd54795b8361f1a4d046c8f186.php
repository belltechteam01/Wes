...
<head>
    ...
    <link id="template_icon" rel="icon" href="<?php echo e($favicon); ?>">
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/wes-default.js')); ?>"></script>
...
<?php
 ...
 if(isset($curMU) && !empty($curMU) && $curMU==='home')
    $bkdis="block";
?>
<div class="home_mark_slider_img" style="display:<?php echo e($bkdis); ?>">
    <div class="home_mark_slider_img_svg_container">
        <svg version="1.1" id="Í¼²ã_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<div class="page-container" id="page-container-logbk-reg">
    ...
    <section>
        <div class="no-gutters top-row" id="headerTopBar" style="height: 4.5vh/*50px*/; <?php if($topheader==='off'): ?> display:none; <?php endif; ?>">
            <div class="d-flex flex-row" id="headerTopBarArea">
                <div class="d-flex align-items-center">
                    <!--class="material-icons">edit_location</i-->
                    <i class="fas fa-map-marker-alt" aria-hidden="true" <?php if($toplocation==='off'): ?>style="display: none"<?php endif; ?>></i>
                </div>
                <div id="topcountrycity" style="padding-left: 5px; <?php if($toplocation==='off'): ?> display:none; <?php endif; ?>">
                    <?php echo e($countrycity); ?>
            ...
            <div class="mycontainer nav-mycontainer">
                    ...
                    <div class="d-flex flex-row logocontainer">
                        <div>
                            <?php if(!empty($logoImg)): ?>
                                <img src="/uploads/images/wesimg/logo/<?php echo e($logoImg); ?>" alt="logo" id="logostar" class="logo star" style="/*width: 40px;*/ height: 3.6vh/*40px*/;" onerror="this.src ='/images/noimg.png';">
                            <?php endif; ?>
                        </div>
                        <?php if(!empty($logoImg) && !empty($extralogoImg)): ?>
                            <div class="logocontainerLine" style="border-right: 1px solid white; height: 3.6vh/*40px*/; margin: 0 10px;">
                            </div>
                        <?php endif; ?>
                        <div>
                            <?php if(!empty($extralogoImg)): ?>
                                <img src="/uploads/images/wesimg/logo/<?php echo e($extralogoImg); ?>" alt="logo" id="logoflw" class="logo flw" style="width: 7.2vh/*80px*/; height: 3.6vh/*40px*/;" onerror="this.src ='/images/noimg.png';">
                            <?php endif; ?>
                            <?php if(!empty($slogantxt)): ?>
                                <span style="color: white; margin-left: 15px;"><?php echo e($slogantxt); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto" style="height: 3.6vh/*40px*/">
                        ...
                        ?>
                    <!-- group of menu -->
                        <?php $__currentLoopData = $topmenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            $menusp=explode(':', $mu);
                            $menu=$menusp[0];
                            ...
                            ?>
                            <li class="nav-item">
                                <a class="nav-link nav-link-a wesheadmenu <?php echo e($active); ?>" style="font-size: 15px;padding: 0px" data-idx="<?php echo e($i); ?>" data-cont="<?php echo e($link); ?>" title="<?php echo e($menu); ?>" href="/<?php echo e($link); ?>"><?php echo e($menu); ?></a>
                            </li>
                        <?php
                        $i++;
                        ?>
                    ...
                    <!-- language options-->
                        <li id="LangContainer" class="nav-item dropdown" style="padding-right: 0px; <?php if($modules==='off'): ?> display:none; <?php endif; ?>">
                            <?php
                            $i=0;
                            ?>
                            <div id="langDropdownBtn" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor: pointer; padding: 0 0;" class="nav-link dropdown-toggle">
                                <?php if($ciso!=null && $ciso!=''): ?>
                                    <div class="iti__flag-box only-text">
                                        <div class="iti__flag only-text iti__<?php echo e($ciso); ?>"><?php echo e($ciso); ?></div>
                                    </div>
                            ...
                            <div id="langDropdownList" aria-labelledby="SClangDropdown" class="dropdown-menu dropdown-menu-right shadow animated&amp;#45;&amp;#45;grow-in" style="min-width: 8rem;width: auto;">
                                ...
                                <?php if($langs!=null && $langs!=''): ?>
                                    ...
                                    <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <a class="dropdown-item" id="scEnabledLangs_<?php echo e($idstr); ?>" title="<?php echo e($lang->name); ?>" style="color: #212529;padding: 5px 15px;text-align:left" href="/<?php echo e($lang->iso); ?>">
                                            <span class="iti__country-name" style="background: #3f6ad2; color: white; text-transform:uppercase;border: 1px solid transparent; border-radius: 20px; padding: 5px 3px; font-size: 12px"><?php echo e($lang->iso); ?></span>
                                            <span class="iti__country-name" title="<?php echo e($lang->name); ?>" style="font-size: 15px"><?php echo e($lang->name); ?></span>
                                        </a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </div>
    ...
    <section class="section-foot">
        ...
        <div class="row no-gutters" id="footlists" style="background-color: white; height: 22vh; border-top: 1px solid #e2dede;">
            <div class="container">

                <div class="row no-gutters d-flex flex-row justify-content-between" style="">
                    <!-- Service -->
                    <div class="col-3">
                        <aside class="widget widget_text student-txt-area" >
                            <h4 class="student-txt-h4" style="font-size: 16px; font-weight: bold; color: #3859ad; margin-bottom: 1.8vh/*20px*/">
                                <?php if($footmenus!==''): ?>
                                    <?php if($menu0style === 'normal'): ?>
                                        <?php echo e($menu0fonttitle); ?>
                                    ...
                                    <?php if($menu0style === 'normal'): ?>
                                        ...
                                        <?php if($menu0contlinks !==''): ?>
                                            ...
                                            <ul style="list-style: none outside; margin: 0; padding: 0;">
                                                <?php $__currentLoopData = $servicelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    $menusp=explode(':', $mu);
                                                    $menu=$menusp[0];
                                                    if(!empty($menusp[1]))
                                                    ...
                                                    <li style="margin-bottom: 0.9vh/*10px*/">
                                                        <i style="margin-right: 7px;<?php echo e($fontsize); ?> <?php echo e($fontclr); ?>" class="far fa-arrow-alt-circle-right"></i>
                                                        <a class="wesfootlist1" href="<?php echo e($link); ?>" style="<?php echo e($fontsize); ?> <?php echo e($fontclr); ?>" data-cont="<?php echo e($link); ?>"><?php echo e($menu); ?></a>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        <?php endif; ?>
                    ...
                    <div class="col-3">
                        <aside class="widget widget_text student-txt-area">
                            <h4 class="student-txt-h4" style="font-size: 16px; font-weight: bold; color: #3859ad; margin-bottom: 1.8vh/*20px*/">
                                <?php if($footmenus!==''): ?>
                                    <?php if($menu1style === 'normal'): ?>
                                        <?php echo e($menu1fonttitle); ?>
                    ...
                    <div class="col-3">
                        <aside class="widget widget_text student-txt-area" >
                            <h4 class="student-txt-h4" style="font-size: 16px; font-weight: bold; color: #3859ad; margin-bottom: 1.8vh/*20px*/">
                                <?php if($footmenus!==''): ?>
                                    <?php if($menu2style === 'normal'): ?>
                                        <?php echo e($menu2fonttitle); ?>
                                        ...
                                        <?php if($menu2contlinks !==''): ?>
                                            ...
                                            <ul style="list-style: none outside; margin: 0; padding: 0;">
                                                <?php $__currentLoopData = $servicelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                    <li style="margin-bottom: 0.9vh/*10px*/">
                                                        <i style="<?php echo e($fontsize); ?> <?php echo e($fontclr); ?>" class="far fa-arrow-alt-circle-right"></i>
                                                        <a class="wesfootlist1" href="<?php echo e($link); ?>" style="<?php echo e($fontsize); ?> <?php echo e($fontclr); ?>" data-cont="<?php echo e($link); ?>"><?php echo e($menu); ?></a>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                    ...
                    <div class="col-3">
                        <aside class="widget widget_text student-txt-area" style="display: flex; justify-content: center">
                            <div class="grid-container" id="social_site_link">
                                ...
                                $g_idx=0;
                                ?>
                                <?php if($instrjson !=='' && $instrjson !==null): ?>
                                    <?php $__currentLoopData = $instrjson; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <?php if($g_idx == 4): ?>
                                            <?php if($i_img !== ""): ?>
                                                <div class="social-grid grid-item">
                                                    <a href="#" class="social_org_img active" id="social-org_<?php echo e($imgidx); ?>" data-idx="<?php echo e($imgidx); ?>" data-link="<?php echo e($i_link); ?>" target="_blank">
                                                        <img src="<?php echo e($icon_path); ?><?php echo e($i_img); ?>" id="social-iimg_<?php echo e($imgidx); ?>" style="width: 25px; height: 25px">
                                                    </a>
                                                    <?php if($h_img !== ""): ?>
                                                        <a href="#" class="social_hover_img" id="social-hover_<?php echo e($imgidx); ?>" data-idx="<?php echo e($imgidx); ?>" data-link="<?php echo e($i_link); ?>" target="_blank">
                                                            <img src="<?php echo e($icon_path); ?><?php echo e($h_img); ?>" id="social-himg_<?php echo e($imgidx); ?>" style="width: 25px; height: 25px">
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endif; ?>
        ...
        <div class="row no-gutters" style="background-color: white; border-top: 1px solid #e2dede; height: 5vh; bottom: 0; top: 0; align-items: center;padding-right: 9rem">
            <div class="container">
                <div class="myflex-container no-gutters flex-row justify-content-between">
                    <div id="app_foot_left">
                        <?php if($footbar!=='' && $footbar!==null): ?>
                            <?php if($barleft==='normal'): ?>
                                <?php
                                $color = '';
                                $fontsize= '';
                                ?>
                                <?php if(!empty($barleftfontcolor)): ?>
                                    <?php
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                <?php endif; ?>
                                <a href="<?php echo e($barleftfontlink); ?>" style="<?php echo e($color.$fontsize); ?>">
                                    <?php if(!empty($barleftfontcont)): ?>
                                        <?php echo e($barleftfontcont); ?>

                                    <?php endif; ?>
                                </a>
                            <?php else: ?>
                                <script type="text/javascript">
                                    var tag = '<?php echo e($footedit0); ?>';
                                    if(tag!==null && tag!=='')
                    ...
                    <div id="app_foot_center">
                        <?php if($footbar!==''): ?>
                            <?php if($barcent==='normal'): ?>
                                <?php
                                $color = '';
                                $fontsize= '';
                                ?>
                                <?php if(!empty($barcentfontcolor)): ?>
                                    <?php
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                <?php endif; ?>
                                <a href="<?php echo e($barcentfontlink); ?>" style="<?php echo e($color.$fontsize); ?>">
                                    <?php if(!empty($barcentfontcont)): ?>
                                        <?php echo e($barcentfontcont); ?>

                                    <?php endif; ?>
                                </a>
                            <?php else: ?>
                                <script>
                                    var tag = '<?php echo e($footedit1); ?>';
                                    // document.getElementById("app_foot_center").innerHTML=htmldecodejs(tag);
                                    if(tag!==null && tag!=='')
                    ...
                    <div id="app_foot_right">
                        <?php if($footbar!==''): ?>
                            <?php if($barright==='normal'): ?>
                                <?php
                                $color1 = '';
                                $fontsize1='';
                                ?>
                                <?php if(!empty($barrightfontcolor)): ?>
                                    <?php
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                <?php endif; ?>
                                <a href="<?php echo e($barrightfontlink); ?>" style="<?php echo e($color1.$fontsize1); ?>">
                                    <?php if(!empty($barrightfontcont)): ?>
                                        <?php echo e($barrightfontcont); ?>

                                    <?php endif; ?>
                                </a>
                            <?php else: ?>
                                <script>
                                    var tag = '<?php echo e($footedit2); ?>';
                                    // document.getElementById("app_foot_center").innerHTML=htmldecodejs(tag);
                                    if(tag!==null && tag!=='')
...
<script type="text/javascript">
    ...
    var contenth=$('section.section-main').height();
    if(contenth < 300){//position: fixed;bottom: 0;right: 0;width: 100%;
        $('section.section-foot').css({'position':'fixed','bottom':'0','width':'100%'});
    }
    ...
    $(document).ready(function () {
       ...
       SocialEnvent();
        ...
        var toplocation = '<?php echo e($toplocation); ?>';
        if (toplocation === 'on') {
            $.ajax({
...
<?php /**PATH D:\work\Project\02_laravel\02_test\Test01_dev_env_setup\wes\resources\views/layouts/template_layout.blade.php ENDPATH**/ ?>