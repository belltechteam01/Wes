        ...
        <div class="row">
            <div class="col-md-12" id="EmailManageAddLayout">
                <div class="card border-0 m-b-10 text-right">
                    <div>
                        <div class="btn btn-outline-light dash-my-btn-0 active p-l-r-30" @click.stop="addEmailManage_Btn">
            ...
            <div class="col-md-12 page_roles_content_list active" id="edit_emailmanage">
                <form method="post" enctype="multipart/form-data" name="emailmanage_frm" id="emailmanage_frm">
                    <div class="card">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex">
                                <div class="col-md-1 col-sm-1" style="line-height: 40px; margin-left: 30px;">
    ...
    export default {
        ...
        methods: {
            ...
            SaveEmailManageContent(){
                if(!is_edit)
                    saveEmailManageApprovalList();
                else
                    editEmailManageApprovalList();
            },
            GotoEmailManagelist(){
                initEmailManagerPage(0);
            },
