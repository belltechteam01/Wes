<template>
    <div style="width:100%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 m-b-10 text-right">
                    <div>
                        <div class="btn btn-outline-light dash-my-btn-0 active p-l-r-30" @click.stop="addAWC_SettingClassSize_Btn">
            ...
            <!--age start-->
            <div class="col-md-12 page_roles_content_list active" id="classsize">
                <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="sum-department-list" class="table table-lg  no-footer" role="grid" aria-describedby="user-list_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th>{{cpgtxt_name}}</th>
                                    <th>{{cpgtxt_min}} {{cpgtxt_size}}</th>
                                    <th>{{cpgtxt_max}} {{cpgtxt_size}}</th>
                                    <th style="text-align:right; padding-right: 40px;">
                                        <div class="awcs_classsize_all_delete" style="cursor: pointer;color: #1e598d;">{{cpgtxt_delete}}</div>
                                    </th>
                                </tr>
                                </thead>
                                <tbody id="awcs_classsize_tbody">
        ...
        <!--age Modal start-->
        <div class="modal fade" id="ModalAWCSettingClassSize">
            <div class="modal-dialog modal-dialog-centered modal-sm" style="min-width: 500px!important;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="ModalAWCSettingTitle">{{cbtntxt_add}} {{cpgtxt_classsize}}</h4>
                            ...
                            <form id="ssfe-email-frm">
                                <div class="row" style="padding-bottom: 20px;">
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-md-4">
                                                <label style="margin-top: 8px; color:#666;" id="ModalAWCSettingNameLavel">{{cpgtxt_name}}</label>
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-md-4">
                                                <label style="margin-top: 8px; color:#666;" id="ModalAWCSettingMinLavel">{{cpgtxt_min}} {{cpgtxt_size}}</label>
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-md-4">
                                                <label style="margin-top: 8px; color:#666;" id="ModalAWCSettingMaxLavel">{{cpgtxt_max}} {{cpgtxt_size}}</label>
                                            </div>
                                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <div id="ssfe-age-model-add" class="btn btn-outline-light  dash-my-btn-0 active p-l-r-35" @click.stop="addClassSizeModalBtn">
                                            <span>+ {{cbtntxt_add}}</span>
                                        </div>
                                    </div>
                                </div>
