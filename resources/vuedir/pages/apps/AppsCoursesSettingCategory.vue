<template>
    <div style="width:100%;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 m-b-10 text-right">
                    <div>
                        <div class="btn btn-outline-light dash-my-btn-0 active p-l-r-30" @click.stop="addAWC_Setting_Btn()">
            ...
            <!--age start-->
            <div class="col-md-12 page_roles_content_list active" id="category">
                <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="sum-department-list" class="table table-lg  no-footer" role="grid" aria-describedby="user-list_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th>{{cpgtxt_name}}</th>
                                    <th>{{cpgtxt_category}}</th>
                                    <th style="text-align:right; padding-right: 40px;">
                                        <div class="awcs_category_all_delete" style="cursor: pointer;">{{cpgtxt_delete}}</div>
                                    </th>
                                </tr>
                                </thead>
                                <tbody id="awcs_category_tbody">
        ...
        <div class="modal fade" id="ModalAWCSetting">
            <div class="modal-dialog modal-dialog-centered modal-sm" style="min-width: 500px!important;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="ModalAWCSettingTitle">{{cbtntxt_add}} {{cpgtxt_category}}</h4>
                                ...
                                <div class="row" style="padding-bottom: 20px;">
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-md-4">
                                                <label style="margin-top: 8px; color:#666;" id="ModalAWCSettingNameLavel">{{cpgtxt_category}} {{cpgtxt_name}}</label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id="AWCSetting_Input_item" name="AWCSetting_Input_item">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-md-4">
                                                <label style="margin-top: 8px; color:#666;" id="ModalAWCSetting_Select_Title">{{cpgtxt_superior}} {{cpgtxt_category}}</label>
                                            </div>
                                            <div class="col-md-8">
                                                <select class="form-control w-100" id="ModalAWCSetting_Select_items" name="ModalAWCSetting_Select_items" >
