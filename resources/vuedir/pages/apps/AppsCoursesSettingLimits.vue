        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 m-b-10 text-right">
                    <div>
                        <div class="btn btn-outline-light dash-my-btn-0 active p-l-r-30" @click.stop="addAWC_SettingLimits_Btn">
            ...
            <!--language start-->
            <div class="col-md-12 page_roles_content_list active" id="limits">
                <div class="card">
                            ...
                            <table id="sum-department-list" class="table table-lg  no-footer" role="grid" aria-describedby="user-list_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th style="text-align:right; padding-right: 40px;">
                                        <div class="awcs_limits_all_delete" style="cursor: pointer;color: #1e598d;">{{cpgtxt_delete}}</div>
                                    </th>
                                </tr>
                                </thead>
                                <tbody id="awcs_limits_tbody">
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" style="min-width: 500px!important;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="ModalAWCSettingTitle">{{cbtntxt_add}} {{cpgtxt_limits}}</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body" id="ModalAWCSettingbody" style="padding:0 1.5rem 1.5rem 1.5rem;">
                        <div class="panel" id="tab4">
                            <form id="ssfe-limits-frm">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <div id="ssfe-limits-model-add" class="btn btn-outline-light  dash-my-btn-0 active p-l-r-35" @click.stop="addLimitsModalBtn">
                                            <span>+ {{cbtntxt_add}}</span>
                                        </div>
                                    </div>
                                </div>
