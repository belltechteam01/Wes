            ...
            <div class="page-title">
                ...
                <span style="color:#656262">&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;
                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                        ...
                        &nbsp;&nbsp; &nbsp;&nbsp; {{cmu_system}} &nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;{{cmusu_system_set}}&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;{{cmususu_system_set_lang}} &nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;{{cmusususu_system_setting_language_trans}}
                          <a href="#" id="system-setting-language-translation-fav" data-status="off" data-page-info="Translation_system-setting-language-translation">
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" style="min-width: 500px!important;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" style="color: #055ada;font-size: 17px;font-weight:800;padding-top: 10px;padding-left: 10px;">{{cpgtxt_editstring}}</h4>
                                ...
                                <div class="row" style="padding-bottom: 10px;">
                                    ...
                                    <div style="margin: 10px 10px 0px 10px;">
                                        <div class="row" style="padding: 10px">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label style="margin-top: 8px; color:#666; width:100px;" id="lb_lang_trans">{{cpgtxt_changestring}}</label>
                                                </div>
                                            </div>
                                            <div class="col-md-10" style="padding-left: 62px;">
                                                <div class="input-group mb-3">
...
export default {
    ...
    computed: {
        ...
        cpgtxt_editstring:function () {
            return this.pgtxt_editstring;
        },
        cpgtxt_changestring:function () {
            ...
            axios.post('admin.sslang_getStoredLang').then((response) => {
                ...
                if(msg === "ok")
                {
                    if(response.data.cnt>0){
                        ...
                        this.getTransContLangs('en');//when start first
                    }
                }
