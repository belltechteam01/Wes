<template>
    <div class="content">
        ...
        <form action="admin.dashboard" enctype="multipart/form-data" id="globalprofile_frm" method="get" target="_top">
...
<script>
    ...
    function EncodeEmailAndMobile(){
        var mod_email = '';
        //var conv_emails = $('#global-user-profile-email').val().split("@");
        ...
        var mod_mobile = '';
        //var conv_mobile = $('#global-user-profile-tel').val();
