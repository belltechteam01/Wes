    ...
    <div class="content">
        ...
        <div class="page-header">
            <div class="page-title">
                <h3>{{cmusususu_webs_wesglobal_media_audio}}</h3>
                <span style="color:#656262">&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;
                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                        ...
                        &nbsp;&nbsp; &nbsp;&nbsp;{{cmu_webs}} &nbsp;&nbsp;&gt;&gt;&nbsp;{{cmusu_webs_wesglobal}} &nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;{{cmususu_webs_wesglobal_media}} &nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;{{cmusususu_webs_wesglobal_media_audio}}
                          <a href="#" id="webs-wesglobal-media-audio-fav" data-status="off" data-page-info="Audio_webs-wesglobal-media-audio">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            cmusususu_webs_wesglobal_media_audio:function () {
                    ...
                    if($("div#WWGMContextMenu").is(":visible"))
                    {
                        ...
                        else
                        {
                            ...
                            if ($(e.target).is($('div#WWGMContextMenu a.list-group-item'))) {
                                ...
                                else if(id=='list-paste-list')
                                    pasteObj(getSelectedItemInfo());
