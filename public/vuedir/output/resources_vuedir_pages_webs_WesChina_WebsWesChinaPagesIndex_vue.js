"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_vuedir_pages_webs_WesChina_WebsWesChinaPagesIndex_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _assets_jsfunc_device_area__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../assets/jsfunc/device_area */ "./resources/vuedir/assets/jsfunc/device_area.js");
//
//
//
//
...
function sliderPanelInit(jslists) {
  ...
  var pgtxt_Image = _assets_jsfunc_mjs_module__WEBPACK_IMPORTED_MODULE_2__.default.data.getByAjaxtext(vueOBJ.$store.state.sitecontents, 'pgtxt_image');
  ...
  if (isarray) {
    for (var i = 0; i < lists.length; i++) {
      ...
      var id = 'id_' + i;
      var border = '';
      if (i > 0) border = ' style="border-top: 1px solid #dbd7d7;"';
  ...
  $('input[name^="new_image_file_"]').change(function () {
    ...
    if (deviceval == null || deviceval == "") {
      _assets_jsfunc_mjs_module__WEBPACK_IMPORTED_MODULE_2__.default.data.showAlert('pgtxt_plsselectdevicetype');
      return;
    }
          ...
          $.ajax({
            ...
            success: function success(data) {
              if (data.msg == "ok") {
                ...
                if (data.list == '') $('#picture-container').html('');else sliderPanelInit(data.list);
  ...
  $('.panelEditBtn').click(function () {
    ...
    if (selected_image_name == '') {
      _assets_jsfunc_mjs_module__WEBPACK_IMPORTED_MODULE_2__.default.data.showAlert('pgtxt_plsselectsliderimageset');
      return;
    }
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default().post('admin.getSiteLogoStylelist', postData).then(function (response) {
      ...
      if (msg == "ok") {
        ...
        $('tr[id^="slider_"]').click(function () {
          ...
          temp_id = id;
          selected_id = id; //myjs.data.showAlert(imagename);
        });
      } else {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    cmusususu_webs_wesglobal_pages_index: function cmusususu_webs_wesglobal_pages_index() {
    ...
    cpgtxt_teacher: function cpgtxt_teacher() {
    ...
    cpgtxt_playingtime: function cpgtxt_playingtime() {
      return this.pgtxt_playingtime;
    },
    cpgtxt_size: function cpgtxt_size() {
      return this.pgtxt_size;
    },
    cpgtxt_navigation: function cpgtxt_navigation() {
      return this.pgtxt_navigation;
    },
    cpgctl_dots: function cpgctl_dots() {
      return this.pgctl_dots;
    },
    cpgctl_blocked: function cpgctl_blocked() {
      return this.pgctl_blocked;
    },
    cpgtxt_pleaseenter: function cpgtxt_pleaseenter() {
      return this.pgtxt_pleaseenter;
    },
    cpgtxt_seconds: function cpgtxt_seconds() {
      return this.pgtxt_seconds;
    },
    cpgctl_fromrighttoleft: function cpgctl_fromrighttoleft() {
      return this.pgctl_fromrighttoleft;
    },
    cpgctl_fromlefttoright: function cpgctl_fromlefttoright() {
    ...
    cpgtxt_createpicture: function cpgtxt_createpicture() {
    ...
    cpgtxt_slidingtime: function cpgtxt_slidingtime() {
  ...
  mounted: function mounted() {
    ...
    Device_Area = new _assets_jsfunc_device_area__WEBPACK_IMPORTED_MODULE_4__.default.data.deviceCLS(vueOBJ, pgperm, tabstatus, this.pageid); //Device_Area.generateTag();
  ...
  methods: {
          ...
          if (response.data.langlist != '') {
            ...
            $('.page1_translate_span').click(function () {
              ...
              if (len > 0) {
                ...
                $('.page1_alarm_bar').removeClass('active');
                $('.page1_alarm_bar span').text('No Save No Appear');
                if (wwgfield == 'sliderbar') getSliderList();else if (wwgfield == 'teacherbar') getTeacherData();else if (wwgfield == 'studentbar') getStudentData();else if (wwgfield == 'advancedbar') getAdvanData();
              }
            });
          }
        }
    ...
    sliderTabs: function sliderTabs() {
      $('.page1_content_side_bar div.page1_content_side_bar_text').click(function () {
        ...
        $('.page1_alarm_bar span').text('No Save No Appear');
        $('.page1_alarm_bar').removeClass('active');
        if (transedlang == null || transedlang == "") InitFirstLang();
    ...
    picmodalAddBtn: function picmodalAddBtn() {
      var deviceval = Device_Area.getSelectedDevice();
    ...
    addpicmodalclose: function addpicmodalclose() {
      var deviceval = Device_Area.getSelectedDevice();
    ...
    getsliderimgfromfile: function getsliderimgfromfile() {
    ...
    SavePageContent: function SavePageContent() {
      ...
      var deviceval = Device_Area.getSelectedDevice(); //var deviceval = Device_Area.getPageDevices();
    ...
    PageRelease: function PageRelease() {
      ...
      _assets_jsfunc_mjs_module__WEBPACK_IMPORTED_MODULE_2__.default.data.Confirm('pgtxt_release', function (val) {
        if (val) {
          $.ajax({
    ...
    slider_image_add: function slider_image_add() {
      if (selected_id != "") {
        $.ajax({
    ...
    deleteListByDevice: function deleteListByDevice(key, pgename) {
      _assets_jsfunc_mjs_module__WEBPACK_IMPORTED_MODULE_2__.default.data.Confirm('pgtxt_devicepagedeleteconfirm?', function (val) {
        if (val) {
          /*  var tmp =[];
          ...
          $.ajax({
            ...
            success: function success(data) {
              if (data.msg == "ok") {
                ...
                if (device != null) Device_Area.devicePageDelete(key); //call device_area.
              } else _assets_jsfunc_mjs_module__WEBPACK_IMPORTED_MODULE_2__.default.data.showAlert(data.msg);
            },
            error: function error(jqXHR, errdata, errorThrown) {
              console.log(errdata);
    ...
    //no call, no use
    PageInitByDevice_Area: function PageInitByDevice_Area() {
      if (transedlang == null || transedlang == "") InitFirstLang();
  ...
  _createClass(DeviceArea, [{
    ...
    value: function deviceDelEvent() {
      $(".span_deviceitemDel_controller").on("click", function () {
        ...
        if (obj != undefined && obj != null) {
          // DevVueOBJ.deleteListByDevice(key, DevClsOBJ.pgname); //
    ...
    value: function showChangeDlg() {
      ...
      if (cnt_pgOfTab.length == 1) {
        if (selectedword_s.length == 1) show_condion = 0; //
        else if (selectedword_s.length == 2) show_condion = 1; //
        else if (selectedword_s.length == 3) show_condion = 2; //
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/***/ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue":
/*!*************************************************************************!*\
  !*** ./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue ***!
  \*************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _WebsWesChinaPagesIndex_vue_vue_type_template_id_318b3077___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077& */ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077&");
/* harmony import */ var _WebsWesChinaPagesIndex_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./WebsWesChinaPagesIndex.vue?vue&type=script&lang=js& */ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=script&lang=js&");
/* harmony import */ var _WebsWesChinaPagesIndex_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css& */ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  _WebsWesChinaPagesIndex_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _WebsWesChinaPagesIndex_vue_vue_type_template_id_318b3077___WEBPACK_IMPORTED_MODULE_0__.render,
  _WebsWesChinaPagesIndex_vue_vue_type_template_id_318b3077___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************!*\
  !*** ./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebsWesChinaPagesIndex.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css&":
/*!**********************************************************************************************************!*\
  !*** ./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=style&index=0&lang=css&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077&":
/*!********************************************************************************************************!*\
  !*** ./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077& ***!
  \********************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "render": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_template_id_318b3077___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   "staticRenderFns": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_template_id_318b3077___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_WebsWesChinaPagesIndex_vue_vue_type_template_id_318b3077___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077&":
/*!***********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/vuedir/pages/webs/WesChina/WebsWesChinaPagesIndex.vue?vue&type=template&id=318b3077& ***!
  \***********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
  ...
  return _c("div", { staticClass: "content" }, [
    ...
    _c("div", { staticClass: "page-header" }, [
      _c("div", { staticClass: "page-title" }, [
        _c("h3", [_vm._v(_vm._s(_vm.cmusususu_webs_wesglobal_pages_index))]),
        _vm._v(" "),
        _c("span", { staticStyle: { color: "#656262" } }, [
          ...
          _vm._v(
            "\n                             " +
              ...
              "   >>  " +
              _vm._s(_vm.cmusususu_webs_wesglobal_pages_index) +
              "\n                          "
          ),
          _vm._m(0)
        ])
    ...
    _c("div", {
      staticClass: "row",
      attrs: { "data-device": "device-area-container" }
    }),
    _vm._v(" "),
          ...
          [
            _c(
              "div",
              {
                ...
                attrs: { "data-target": "sliderbar" }
              },
              [_vm._v(_vm._s(_vm.cpgtxt_slider))]
            )
          ]
        ),
        _vm._v(" "),
        _c("div", { staticClass: "page_index_tab" }, [
          _c(
            "div",
            {
              ...
              attrs: { "data-target": "teacherbar" }
            },
            [_vm._v(_vm._s(_vm.cpgtxt_teacher) + " " + _vm._s(_vm.cpgtxt_bar))]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "page_index_tab" }, [
          _c(
            ...
            {
              staticClass: "page1_content_side_bar_text",
              attrs: { "data-target": "studentbar" }
            },
            [_vm._v(_vm._s(_vm.cpgtxt_student) + " " + _vm._s(_vm.cpgtxt_bar))]
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "page_index_tab" }, [
        ...
        [
          _c("div", { staticClass: "page1_content_content_bar" }, [
            ...
            _c(
              ...
              [
                ...
                _c("div", { staticClass: "row page2_row" }, [
                  _c("div", { staticClass: "col-md-2" }, [
                    _c("span", [_vm._v(_vm._s(_vm.cpgtxt_navigation))])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-md-3" }, [
                    _c(
                      "select",
                      {
                        ...
                        attrs: { id: "slider_navication" }
                      },
                      [
                        _c("option", { attrs: { value: "1" } }, [
                          _vm._v(_vm._s(_vm.cpgctl_dots))
                        ]),
                        _vm._v(" "),
                        _c("option", { attrs: { value: "0" } }, [
                          _vm._v(_vm._s(_vm.cpgctl_blocked))
                        ])
                      ]
                    )
                  ])
                ...
                _c("div", { staticClass: "row page2_row" }, [
                  _c("div", { staticClass: "col-md-2" }, [
                    _c("span", [_vm._v(_vm._s(_vm.cpgtxt_playingtime))])
                  ]),
                  _vm._v(" "),
                  _vm._m(2),
                  _vm._v(" "),
                ...
                _c("div", { staticClass: "row page2_row" }, [
                  _c("div", { staticClass: "col-md-2" }, [
                    _c("span", [_vm._v(_vm._s(_vm.cpgtxt_slidingtime))])
                  ]),
                  _vm._v(" "),
                  _vm._m(3),
                  _vm._v(" "),
                ...
                _c("div", { staticClass: "row page2_row" }, [
                  _c("div", { staticClass: "col-md-2" }, [
                    _c("span", [_vm._v(_vm._s(_vm.cpgtxt_style))])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "col-md-3" }, [
                    _c(
                      ...
                      {
                        staticClass: "form-control w-75 page2_select",
                        attrs: { id: "slider_sliding_dir" }
                      },
                      [
                        _c("option", { attrs: { value: "1" } }, [
                          _vm._v(_vm._s(_vm.cpgctl_fromrighttoleft))
                        ]),
                        _vm._v(" "),
                        _c("option", { attrs: { value: "2" } }, [
                          _vm._v(_vm._s(_vm.cpgctl_fromlefttoright))
                        ]),
                        _vm._v(" "),
                        _c("option", { attrs: { value: "0" } }, [
                          _vm._v(_vm._s(_vm.cpgctl_blocked))
                  ...
                  _c("div", { staticClass: "col-md-3" }, [
                    _c(
                      "button",
                      {
                        ...
                        attrs: { type: "button", id: "slider_image_upbtn" }
                      },
                      [
                        _vm._v(
                          "\n                                    " +
          ...
          _c("div", { staticClass: "page1_content_content_bar" }, [
            ...
            _c(
              "div",
              {
                staticClass: "page1_content_content_bottom cursor-pointer",
                attrs: { id: "id_myAddPicModal" },
                on: { click: _vm.picmodalAddBtn }
              },
              [
                _c(
                  "svg",
        ...
        [
          _c("div", { staticClass: "page1_content_content_bar" }, [
            _c(
              ...
              [
                _c("input", {
                  attrs: { type: "hidden", name: "wfm", value: "tc" }
                }),
                _vm._v(" "),
                _c("input", {
                  attrs: {
                ...
                _c("div", { staticClass: "page1_content_content_title" }, [
                  _vm._v(
                    _vm._s(_vm.cpgtxt_teacher) + " " + _vm._s(_vm.cpgtxt_bar)
                  )
                ]),
                _vm._v(" "),
                _c(
                  ...
                  [
                    ...
                    _c("div", { staticClass: "row page2_row" }, [
                      _c("div", { staticClass: "col-md-2" }, [
                        _c("span", [_vm._v(_vm._s(_vm.cpgtxt_icon))])
                      ]),
                      _vm._v(" "),
                      _vm._m(7),
                      _vm._v(" "),
                      _c("div", { staticClass: "col-md-3" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", id: "teach_file_1_upbtn" }
                          },
                          [
                            _vm._v(
                              "\n                                    " +
                    ...
                    _c("div", { staticClass: "row page2_row" }, [
                      _c("div", { staticClass: "col-md-2" }, [
                        _c("span", [_vm._v(_vm._s(_vm.cpgtxt_link))])
                      ]),
                      _vm._v(" "),
                      _vm._m(9)
                    ])
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "page1_content_content page2_content_text page3_content_content_bottom"
                  },
                  [
                    _c("div", { staticClass: "row page2_row" }, [
                      _c("div", { staticClass: "col-md-2" }, [
                      ...
                      _c("div", { staticClass: "col-md-3" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", id: "teach_file_2_upbtn" }
                          },
                          [
                            _vm._v(
                              "\n                                    " +
                      ...
                      _c("div", { staticClass: "col-md-3" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", id: "teach_file_3_upbtn" }
                          },
                          [
                            _vm._v(
                              "\n                                    " +
          ...
          _c("div", { staticClass: "page1_content_content_bar" }, [
            _c(
              ...
              [
                ...
                _c("div", { staticClass: "page1_content_content_title" }, [
                  _vm._v(
                    _vm._s(_vm.cpgtxt_student) + " " + _vm._s(_vm.cpgtxt_bar)
                  )
                ]),
                _vm._v(" "),
                _c(
                      ...
                      _c("div", { staticClass: "col-md-3" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", id: "stud_file_1_upbtn" }
                          },
                          [
                            _vm._v(
                              "\n                                    " +
                ...
                _c(
                  ...
                  [
                    ...
                    _c("div", { staticClass: "row page2_row" }, [
                      _c("div", { staticClass: "col-md-2" }, [
                        _c("span", [
                          _vm._v(_vm._s(_vm.cpgtxt_font) + " Content2")
                        ])
                      ]),
                      _vm._v(" "),
                      _vm._m(25)
                      ...
                      _c("div", { staticClass: "col-md-3" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", id: "stud_file_3_upbtn" }
                          },
                          [
                            _vm._v(
                              "\n                                    " +
    ...
    _c(
      "div",
      {
        ...
        attrs: { id: "myAddPicModal", role: "dialog" }
      },
      [
          ...
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-header" }, [
              _c(
                ...
                [_vm._v(_vm._s(_vm.cpgtxt_createpicture))]
              ),
              _vm._v(" "),
              _c(
                "button",
                ...
                [
                  _c("input", {
                    attrs: {
                      type: "hidden",
                      name: "transLang",
                      id: "slider_img_transLang",
                      value: ""
                    }
                  }),
                  _vm._v(" "),
                  _c("div", { staticClass: "page2_modal page2_content_text" }, [
                    _c("div", { staticClass: "row page2_row" }, [
                      _c("div", { staticClass: "col-md-2" }, [
                        _c("span", [_vm._v(_vm._s(_vm.cpgtxt_name))])
                      ]),
                      _vm._v(" "),
                      _vm._m(33)
                    ]),
                      ...
                      _c("div", { staticClass: "col-md-3" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button" },
                            on: { click: _vm.getsliderimgfromfile }
                          },
                          [
                            _vm._v(
                              "\n                                        " +
            ...
            _c("div", { staticClass: "modal-footer" }, [
              _c(
                "button",
                {
                  ...
                  attrs: { type: "button", id: "addpic_btn" },
                  on: { click: _vm.addpicmodalclose }
                },
                [
                  _c("span", {
                    staticClass: "iconify",
    ...
    _vm._v(" "),
    _c("div", { staticClass: "modal fade", attrs: { id: "sliderModal" } }, [
      _c(
        "div",
        {
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "a",
      {
        attrs: {
          href: "#",
          id: "webs-wesglobal-pages-index-fav",
          "data-status": "off",
          "data-page-info": "Index_webs-wesglobal-pages-index"
        }
      },
      [
        _vm._v("\n                           "),
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c("span", { attrs: { id: "image_size" } }, [_vm._v("527*300px")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c("input", {
        ...
        attrs: { type: "text", value: "10", id: "slider_playtime" }
      })
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c("input", {
        staticClass: "page2_input",
        attrs: { type: "text", value: "2", id: "slider_sliding_time" }
      })
    ])
  },
  function() {
    ...
    return _c(
      "form",
      {
        attrs: {
          method: "post",
          enctype: "multipart/form-data",
          name: "slider_img_panel_frm",
          id: "slider_img_panel_frm"
        }
      },
      [
        _c("input", {
        ...
        _c("input", {
          attrs: {
            type: "hidden",
            name: "transLang",
            id: "slider_img_panel_frm_transLang",
            value: ""
          }
        }),
        _vm._v(" "),
        ...
        _vm._v(" "),
        _c("input", {
          attrs: { type: "hidden", name: "filesize", id: "filesize", value: "" }
        }),
        _vm._v(" "),
        _c("input", {
          attrs: {
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c("input", {
        ...
        attrs: {
          type: "text",
          placeholder: "Font Content",
          value: "",
          name: "teach_font1_cont",
          id: "teach_font1_cont"
        }
      })
    ])
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c(
        "button",
        {
          ...
          attrs: { type: "button", id: "stud_file_2_upbtn" }
        },
        [
          _vm._v(
            "\n                                    Edit\n                                "
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "row page2_row" }, [
      _c("div", { staticClass: "col-md-2" }, [_c("span", [_vm._v("Link")])]),
      _vm._v(" "),
      _c("div", { staticClass: "col-md-3" }, [
        _c("input", {
          staticClass: "page2_input",
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c("div", { staticStyle: { display: "none" } }, [
        _c("input", {
          attrs: {
            type: "file",
            name: "new_image_file_dlg",
            id: "new_image_file_dlg"
          }
        })
      ]),
      _vm._v(" "),
